        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Editer témoignage</h4>
                            ...
                            <div class="row g-2 g-md-4">
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" required  value=" {{$temoignage->nom}} " type="text" id="nomFr" name="nom" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-2 g-md-4">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <textarea  class="form-control" required name="contenu_fr"  rows="10">{{$temoignage->contenu_fr}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label">Témoignage(Anglais) <span class="text-info">*</span> </label>
                                        <textarea name="contenu_en" required class="form-control"  rows="10">{{$temoignage->contenu_en}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label">Témoignage(Allemand) <span class="text-info">*</span> </label>
                                        <textarea name="contenu_de" required class="form-control"  cols="30" rows="10">{{$temoignage->contenu_de}}</textarea>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3">
...
@section('script')
    <script>
        let image =  '<?php echo $temoignage->image ?>'  
