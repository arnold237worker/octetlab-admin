    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-12">
                <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                    <h4 class="mb-sm-0">Modifier un pack</h4>
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="card mb-5">
                    <div class="card-body">
                        <h4 class="card-title">Modifier un pack</h4>
                            ...
                            <div class="row g-2 g-md-4">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control" required value=" {{$package->nom_fr}} "  type="text" id="nomFr" name="nom_fr" >
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label" for="nomEn">Nom du pack(Anglais) <span class="text-info">*</span></label>
                                        <input class="form-control" required value=" {{$package->nom_en}} "  type="text" id="nomEn" name="nom_en" >
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label" for="nomDe">Nom du pack(Allemand) <span class="text-info">*</span> </label>
                                        <input class="form-control" required type="text" value=" {{$package->nom_de}} "  id="nomDe" name="nom_de" >
                                    </div>
                                </div>
                            </div>
                            ...
                            <div class="row g-2 g-md-4">
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        ...
                                        <textarea  class="form-control" required name="services_fr" placeholder="Séparer les services par une virgule. Exemple: Service1, Service2, etc..."  rows="10">{{$package->services_fr}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label">Services (Anglais) <span class="text-info">*</span> </label>
                                        <textarea name="services_en" required class="form-control" placeholder="Séparer les services par une virgule. Exemple: Service1, Service2, etc..."  rows="10">{{$package->services_en}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-4">
                                    <div class="mb-3">
                                        <label class="form-label">services (Allemand) <span class="text-info">*</span> </label>
                                        <textarea name="services_de" required class="form-control" placeholder="Séparer les services par une virgule. Exemple: Service1, Service2, etc..."  cols="30" rows="10">{{$package->services_de}}</textarea>
                                    </div>
                                </div>
                                <div class="col-lg-12">
                                    <div class="mb-3">
                                        <label class="form-label" for="prix">Prix du pack  </label>
                                        <input class="form-control" type="text" value="{{$package->prix}}" id="prix" name="prix" >
                                    </div>
                                </div>
                            </div>
